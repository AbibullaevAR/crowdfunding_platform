...
from .views import CreateUserView, ConfirmEmailView, RetrieveUserView, ListUserView, UpdateUserStatusView
...
urlpatterns = [
    ...
    path("user_status/<uuid:id>/", UpdateUserStatusView.as_view(), name="user_status")
]